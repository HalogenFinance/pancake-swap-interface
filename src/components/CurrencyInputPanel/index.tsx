    ...
    <InputPanel id={id}>
      <Container hideInput={hideInput}>
        {!hideInput && (
          <LabelRow>
            <RowBetween>
              <Text fontSize="14px" style={{color: '#fff', marginBottom: '10px', marginLeft: '-10px'}} >{label}</Text>
              {account && (
                <Text onClick={onMax} fontSize="14px" style={{ display: 'inline', color: '#fff', cursor: 'pointer' }}>
        ...
        <CurrencySelect
          ...
          >
            <Aligner>
              ...
              {!disableCurrencySelect && <ChevronDownIcon fill="#fff" />}
            </Aligner>
          </CurrencySelect>
          {!hideInput && (
            <>
